...
VALUES ('4','7','1','2025-02-14 16:30:00','2025-02-14 17:30:00');
...
FROM (SELECT attendance.location_id, date(attendance.check_in_time) AS visit_date,
    COUNT(*) AS daily_count
    FROM attendance
    GROUP BY attendance.location_id,
